...
$state = false;
	if ($_POST['action'] == "add") { 
	$grab1="UPDATE  album  SET  SUBTITULO='" .$_POST['SUBTITULO']. "', TITULO ='" .$_POST['TITULO']. "' , AUTOR ='" .$_POST['AUTOR']. "' , CATEGORIA ='" .$_POST['CATEGORIA']. "' , FECHA ='" .$fechayhora. "' , SECCION ='" .$_POST['SECC']. "' where  IDEN=". $viewart;
	$grab2="UPDATE  album  SET  SUBTITULO='" .$_POST['SUBTITULO']. "', TITULO ='" .$_POST['TITULO']. "' , AUTOR ='" .$_POST['AUTOR']. "' , CATEGORIA ='" .$_POST['CATEGORIA']. "' , SECCION ='" .$_POST['SECC']. "' where  IDEN=". $viewart;
