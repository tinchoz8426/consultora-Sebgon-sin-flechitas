            ...
            <ul class="nav full pull-right">
              <li class="dropdown user-avatar">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <span>
                    <img class="menu-avatar" src="core/images/avatars/avatar1.jpg" /> <span>Viviana Fornari<i class="icon-caret-down"></i></span>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="with-image">
                    <div class="avatar">
                      <img src="core/images/avatars/avatar1.jpg" />
                    </div>
                    <span>Viviana F.</span>
                  </li>
                  ...
                  <li><a href="#"><i class="icon-cog"></i> <span>Ajustes</span></a></li>
    ...
    <div class="row-fluid">
      ...
      <div class="area-top clearfix">
        <div class="pull-left header">
          ...
          <h5>
            Licencia de uso para : CTN Soporte y Sistemas
          </h5>
        </div>
        ...
        <ul class="inline pull-right sparkline-box">
          ...
          <li class="sparkline-row">
            ...
            <div class="sparkline big" data-color="blue"><!--19,6,22,23,3,20--></div>
          </li>

          <li class="sparkline-row">
            <h4 class="green"><span>Proyectos</span> 223</h4>
            <div class="sparkline big" data-color="green"><!--24,21,28,22,3,9--></div>
          </li>

          <li class="sparkline-row">
            <h4 class="red"><span>Mensajes</span> 7930</h4>
            <div class="sparkline big"><!--27,10,29,17,20,5--></div>
          </li>
        ...
        <div class="row-fluid">
          <div class="span12">
            <div class="dashboard-stats">
              ...
              <div class="progress progress-green"><div class="bar tip" title="80%" data-percent="30"></div></div>
