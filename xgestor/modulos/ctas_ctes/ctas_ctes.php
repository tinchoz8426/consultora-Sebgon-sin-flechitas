							...
							<div class="row">
								<table   class="table datatable table-striped table-bordered" id="ctasctes">
									...
									<tbody>
										...
										$database->connect();
										$clientes_sql = "SELECT * from ctasctes WHERE COMPRA_VENTA=".$mv." AND CLIENTE_PROVEEDOR=".$cl_pr;
										...
										echo "<td>".$row3['VTO_1']."</td>";
										echo "<td>".nombre_contacto($row3['CLIENTE_PROVEEDOR'])."</td>";
										echo "<td>".busca_registro(tipo_comprobante,IDEN,TIPO,$row3['TIPO_COMPROBANTE'])." ".$row3['COMPROBANTE']."</td>";
										echo "<td>".$detalle_movimiento."</td>";
										echo "<td>".$row3['IMPORTE'];
										echo"</tr>";
										}
