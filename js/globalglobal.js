    ...
    $(lightbox.selector).click(function(e){
        ...
        if (this.href.indexOf('.mp4') > -1 || this.href.indexOf('.flv') > -1) {
            ...
            ///
                ...
                */
                //alert(video_width); 
                var skinSrc=g_HttpRelativeWebRoot+'groups/public/documents/webasset/carbon.zip'
				...
				jwplayer("lightbox_flash").setup({
						...
						'width': video_width,
   						...
   						plugins: {
            				...
            				'fbit-1': {'link':currentURL},
	    					'tweetit-1': {'link':currentURL} 
            				
        				},
   						modes: [
   						{type: 'flash', src:swfSrc },
   						{type: 'html5',
   						config: {
           					'file': srcPath,
           					'provider': 'video'
...
lightbox.close = function(){
    ...
    if (lightbox.contentId != false) {
     ...
     if(typeof(jwplayer) != "undefined" && jwplayer("lightbox_flash")){
