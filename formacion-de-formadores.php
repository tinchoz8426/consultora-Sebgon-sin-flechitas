<?php
$titulo = "formacion de formadores, cursos de formacion de formadores";
$k1 = "<h1><strong>formacion de formadores, cursos de formacion de formadores</strong></h1>";
$k2 = "<h2><strong>cursos de formacion de formadores, formacion de formadores</strong></h2>";
$k3 = '<h3><a href="http://www.consultorasebgon.com/formacion-de-formadores.php" target="_self" title="formacion de formadores, cursos de formacion de formadores"><strong>formacion de formadores, cursos de formacion de formadores</strong></a></h3>';
$k4 = "<h4>cursos de formacion de formadores, formacion de formadores</h4>";
$pic = "formacion de formadores, cursos de formacion de formadores";
$pic1 = "formacion de formadores";
$pic2 = "cursos de formacion de formadores";
$links = '<a href="http://www.consultorasebgon.com/formacion-de-formadores.php" target="_self" title="formacion de formadores, cursos de formacion de formadores"><strong>formacion de formadores, cursos de formacion de formadores</strong></a> - <a href="http://www.bsasprotection.com/" target="_blank" title="empresa de seguridad privada">empresa de seguridad privada</a> - <a href="http://www.bsasprotection.com/servicios-de-seguridad-privada.html" title="servicios de seguridad privada" target="_blank">Servicios de Seguridad Privada</a>';
?>
						...
						<div id="content" style="width:650px">
							<div id="splash" style="height:auto">
								<div class="content box-style1">
									<h2 class="title"><span>Formación de Formadores</span></h2>
								</div>
							</div>
							<div class="content">
   <p><img src="formacion-de-formadores.jpg" alt="<?php echo $pic; ?>" width="157" height="152" class="img" style="float:left;padding-right:20px" />Toda persona que se presente para dictar una capacitación, debe contar con determinadas competencias que logren impactar directamente en las personas a formar.</p>
   <p>Seleccionar el método más apropiado de formación, llevar a cabo un análisis de las necesidades de aprendizaje sobre el tema en que va a ser impartido y por sobre todo superar los nervios y asegurar que el enfoque de su exposición sea el correcto para lograr la atención de los participante, son acciones claves para lograr el éxito de la capacitación.</p>
   <p>La formación dictada por los profesionales que trabajan en Sebgon, asegura la transmisión de las capacidades y competencias que debe tener un Formador para lograr sus objetivos.</p>
							</div>
						</div>
